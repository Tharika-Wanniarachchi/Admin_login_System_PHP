    ...
    <div class="main-container">
        <div class="login-container col-md-6 col-sm-8">
            ...
            <div class="login" id="loginForm">
                ...
                <div style="color:rgb(168, 6, 6); padding-bottom:10px;font-size: 18px; font-weight: 500; display:flex; justify-content: center;align-items: center;">
                        <?php
                ...
                <h1 class="text-center form-topic">Admin Panel Login</h1>
